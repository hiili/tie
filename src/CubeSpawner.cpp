...
CubeSpawner::CubeSpawner(float a_size, float a_spawntime, Vector a_location, 
...
{
  /**
   * Add total spawnCount cubes to the spawntstack of Spawner superclass
   */
  for(int i = 0; i < a_spawnCount; i++) {
    pushObject(new Object
      ( Object::Params        
        ...
        ( new ODELocator(),
        /* Create visual for the cubes */
        new BasicVisual( shapes::Cube::create
          ( makeVector3d( a_size, a_size, a_size ) ),
          &TIEMat::whiteMat ),
        /* Create geometry for the cubes */
        new BasicGeometry
          ( shapes::Cube::create( makeVector3d( a_size, a_size, a_size )),
