...
namespace tie {
  ...
  struct TIEMat {
    ...
    static const GLfloat gray1[4];
    static const GLfloat red[4];
    static const GLfloat red05[4];
    ...
    static const GLfloat orange1[4];
    static const GLfloat orange6[4];
    static const GLfloat cyan1[4];
    static const GLfloat cyan6[4];
    static const GLfloat skyBlue[4];
    static const GLfloat skyBlue3[4];
    ...
    static const lifespace::Material whiteEmissionMat;
    static const lifespace::Material emissionMat;
    static const lifespace::Material skyBlueMat;
    static const lifespace::Material groundMat;
    static const lifespace::Material wall1Mat;
    static const lifespace::Material wall2Mat;
    static const lifespace::Material wall3Mat;
    static const lifespace::Material brightWhiteMat;
    static const lifespace::Material purpleMat;    
    static const lifespace::Material polishedMetalMat;

    static const boost::shared_ptr
    <const lifespace::CollisionMaterial> testCollMat;
    static const boost::shared_ptr
    <const lifespace::CollisionMaterial> testCollMat1;
    static const boost::shared_ptr
    <const lifespace::CollisionMaterial> ballCollMat;
  };
